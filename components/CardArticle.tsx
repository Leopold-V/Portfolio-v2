                ...
                <a>
                    <div className={styles.container}>
                        ...
                        <div className={styles.reactions}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-heart" width="20" height="20" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff312d" fill="#ff312d" strokeLinecap="round" strokeLinejoin="round">
